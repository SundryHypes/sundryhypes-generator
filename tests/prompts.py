...
topic = "Stars that do not explode"
...
def get_outro_prompt(starting_host):
    outro_prompt = f'Lastly, finish the dialogue with an outro. The outro should contain a short ' \
                   f'summary of what has been discussed and invite the listeners to tune in again ' \
                   f'in the future. Start with {starting_host}. '
...
print(generate_dialogue_based_on_topic(topic))
